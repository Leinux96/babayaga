...
const BUNDLE_ID = 'com.babayaga'; // ios bundle id
const PACKAGE = 'com.babayaga'; // android package name
const NAME = 'Babyaga'; // app name
const EXPO_ACCOUNT_OWNER = 'leinux'; // expo account owner
const EAS_PROJECT_ID = 'b4260547-ef73-4d9d-a38c-ff02591d6f97'; // eas project id
const SCHEME = 'babyaga'; // app scheme
